...
exports.Chapter = exports.ChapterSpecialType = void 0;
const typeorm_1 = require("typeorm");
const resource_entity_1 = require("./resource.entity");
var ChapterSpecialType;
(function (ChapterSpecialType) {
    ChapterSpecialType["CREDITS"] = "CREDITS";
})(ChapterSpecialType || (exports.ChapterSpecialType = ChapterSpecialType = {}));
...
], Chapter.prototype, "specialType", void 0);
__decorate([
    (0, typeorm_1.ManyToMany)(() => resource_entity_1.Resource, (resource) => resource.chapters, { cascade: false }),
    (0, typeorm_1.JoinTable)(),
    __metadata("design:type", Array)
], Chapter.prototype, "resources", void 0);
