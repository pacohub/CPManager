...
let SoundController = class SoundController {
    ...
    async create(data, files) {
        if (files?.file?.[0])
            data.file = `/uploads/sounds/${files.file[0].filename}`;
...
], SoundController.prototype, "findAll", null);
__decorate([
    (0, common_1.Get)(':id'),
    ...
    __metadata("design:returntype", Promise)
], SoundController.prototype, "findOne", null);
__decorate([
    (0, common_1.Post)(),
...
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], SoundController.prototype, "remove", null);
